...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO posts (title,post_cat, description, slug,posted_by, date) VALUES('$title','$post_cat', '$description', '$slug', '$posted_by', '$date')";
        ...
        <form class="w3-container" method="POST">
            ...
            <p>
                ...
                <select name="category" id="post_category">
                    ...
                    $dataCategory = mysqli_query($dbcon, $query);
                    while ($row = mysqli_fetch_array($dataCategory)) {
